...
build/deps/xyce-7.10-serial-release/      # SuiteSparse、Trilinos 各自的 build tree
out/deps/xyce-7.10-serial-release/        # 分层依赖的安装前缀
...
- CMake、编译器、flex、bison 的版本和绝对路径；
- 每层完整 CMake configure 命令；
